...
public class GameView extends View {
    ...
    private int BLUE_SIZE = getResources().getInteger(R.integer.blue_size);
    ...
    private int KPU_TAP_SPEED = getResources().getInteger(R.integer.kpu_tap_speed);
    private int KPU_FALL_SPEED = getResources().getInteger(R.integer.kpu_fall_speed);
